...
// Polish mirror of BeforeAfterMixing — same audio demos (section = 'mixing'),
// Polish section heading and card UI labels. Track titles come from the DB
// (shared with the English page) and are left as-is.
const plLabels = {
    raw: "Nagranie surowe",
    final: "Miks finalny",
    live: "Na żywo",
